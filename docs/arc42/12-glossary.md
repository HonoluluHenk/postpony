...
The ubiquitous language is maintained in [`CONTEXT.md`](../../CONTEXT.md) — the canonical glossary of domain terms (Postponement, Match, Match Format, Organizer, Opponent Captain, Captain Password, Player Password, Player, Participant, Proposed Date, Opponent Votable, Accepted, Clash, Venue, Venue Occupancy, Vote, Status, click-tt Team Identity, Fixture Mode, Planning Window, iCal Export, Club, Locale, and their _Avoid_ anti-terms).
