...
Status: open Label: wayfinder:task Parent: map.md Blocked by: issues/01-own-team-completion-signal.md, issues/02-opponent-pre-proposal-experience.md, issues/03-status-semantics.md
