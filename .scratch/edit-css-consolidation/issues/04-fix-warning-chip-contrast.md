...
- [ ] The warning chip's text contrast against its background is at least 4.5:1 (axe on the edit page is green).
- [ ] The chip's class and markup are unchanged; only token values changed.
- [ ] Edit-page screenshot baselines are regenerated and reviewed before commit.
